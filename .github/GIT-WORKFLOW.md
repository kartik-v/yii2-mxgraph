Git workflow for yii2-mxgraph contributors
=======================================

So you want to contribute to yii2-mxgraph? Great! But to increase the chances of your changes being accepted quickly, please
...
### 1. [Fork](http://help.github.com/fork-a-repo/) the yii2-mxgraph repository on GitHub and clone your fork to your development environment 

```
git clone git@github.com:YOUR-GITHUB-USERNAME/yii2-mxgraph.git
```
...
### 2. Add the main yii2-mxgraph repository as an additional git remote called "upstream"

Change to the directory where you cloned yii2-mxgraph, normally, "yii2-mxgraph". Then enter the following command:

```
git remote add upstream git://github.com/kartik-v/yii2-mxgraph.git
```

### 3. Prepare the testing environment

- You should have a working yii 2 development environment in which you have already installed `yii2-mxgraph` and includes latest and updated `yii2-mxgraph` fork from source.
- Ensure you have the latest `dev-master` releases of all dependent extensions via your composer updates
- Ensure you use the above cloned latest `yii2-mxgraph` code in your testing environment

**Now you have a working playground for hacking on yii2-mxgraph.**
...
### 2. Fetch the latest code from the main yii2-mxgraph branch
...
### 3. Create a new branch for your feature based on the current yii2-mxgraph master branch
...
### 7. Pull the latest yii2-mxgraph code from upstream into your branch
...
you should fix them now and commit the changes again. This ensures that it's easy for the yii2-mxgraph team to merge your changes
with one click.
...
and become part of the next yii2-mxgraph release. If not, don't be disheartened, different people need different features and yii2-mxgraph
